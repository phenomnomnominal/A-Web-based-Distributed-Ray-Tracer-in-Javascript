...
# The [`connect`](http://www.senchalabs.org/connect/) [**`Session`**](http://www.senchalabs.org/connect/middleware-session.html) class is also required:
#
# * **`Session`** - Session data creation
    ...
    sio.configure ->
      sio.set 'authorization', (data, accept) ->
        if data.headers.cookie
          ...
          accept 'No cookie transmitted.', no
