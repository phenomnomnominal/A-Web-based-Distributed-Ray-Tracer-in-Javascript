$(document).ready ->
  ...
  test 'Test for Errors when passing incorrect arguments to the required parameters of the TriangleMesh constructor:', ->
    ...
    raises ->
      ...
      'an Error is thrown (by the Shape constructor): "reverseOrientation must be defined."'
    ...
    raises ->
      ...
      , /numberTriangles must be defined./,
      'an Error is thrown (by the TriangleMesh constructor): "numberTriangles must be defined."'
    ...
    raises ->
      ...
      , /numberTriangles must be a Number./, 
      'an Error is thrown (by the TriangleMesh constructor): "numberTriangles must be a Number."'
    nt = 1
    ok nt?, 'If we create a numberTriangles Number and pass it into the constructor'
    raises ->
        tm = new TriangleMesh(o2w, w2o, ro, nt)
      , /numberVertices must be defined./,
      'an Error is thrown (by the TriangleMesh constructor): "numberVertices must be defined."'
    ...
    raises ->
      ...
      , /numberVertices must be a Number./,
      'an Error is thrown (by the TriangleMesh constructor): "numberVertices must be a Number."'
    nv = 3
    ok nv?, 'If we create a numberVertices Number and pass it into the constructor'
    raises ->
        tm = new TriangleMesh(o2w, w2o, ro, nt, nv)
      , /vertexIndices must be defined./,
      'an Error is thrown (by the TriangleMesh constructor): "vertexIndices must be defined."'
    ...
    raises ->
      ...
      , /vertexIndices must be an Array./,
      'an Error is thrown (by the TriangleMesh constructor): "vertexIndices must be an Array."'
    vi = [1, 2, 3]
    ...
    raises ->
      ...
      'an Error is thrown (by the TriangleMesh constructor): "positions must be defined."'
    ...
    raises ->
      ...
      'an Error is thrown (by the TriangleMesh constructor): "positions must be an Array".'
  ...
  test 'Test for Errors when passing incorrect values to the parameters of the TriangleMesh constructor that have default arguments:', ->
    ...
    raises ->
      ...
      , /normals must be an Array./,
      'an Error is thrown (by the TriangleMesh constructor): "normals must be an Array"'
    ok notArray?, 'If we pass a non-Array Object into the constructor as tangents'
    raises ->
        tm = new TriangleMesh(o2w, w2o, ro, nt, nv, vi, p, [], notArray)
      , /tangents must be an Array./,
      'an Error is thrown (by the TriangleMesh constructor): "tangents must be an Array"'
    ok notArray?, 'If we pass a non-Array Object into the constructor as uvs'
    raises ->
        tm = new TriangleMesh(o2w, w2o, ro, nt, nv, vi, p, [], [], notArray)
      , /uvs must be an Array./,
      'an Error is thrown (by the TriangleMesh constructor): "uvs must be an Array"'
  ...
  test 'Test creating a new TriangleMesh, supplying only the required arguments to the constructor:', ->
    ...
    ok tm.numberTriangles?, 'which has a property named "numberTriangles"'
    equal tm.numberTriangles, nt, 'which is equal to the argument "nt" (1)'
    ok tm.numberVertices?, 'and a property named "numberVertices"'
    equal tm.numberVertices, nv, 'which is equal to the argument "nv" (3)'
    ok tm.vertexIndices?, 'and a property named "vertexIndices"'
    ok _.isArray(tm.vertexIndices), 'which is an Array'
    ...
    ok tm.positions?, 'It should also have a property name "positions"'
    ok _.isArray(tm.positions), 'which is an Array'
    ...
    ok tm.normals?, 'It should also have a property named "normals"'
    ok _.isArray(tm.normals), 'which is an Array'
    equal tm.normals.length, 0, 'of length 0,'
    ok tm.tangents?, 'and a property named "tangents"'
    ok _.isArray(tm.tangents), 'which is an Array'
    equal tm.tangents.length, 0, 'of length 0,'
    ok tm.uvs?, 'and a property named "uvs"'
    ok _.isArray(tm.uvs), 'which is an Array'
  ...
  test 'Test that "objectBound" works correctly for a TriangleMesh instance:', ->
    ...
    ok bounds? and bounds.constructor.name is "BoundingBox", 'it should return a BoundingBox'
  ...
  test 'Test that "canIntersect" works correctly for a TriangleMesh instance:', ->
    ...
    equal tm.canIntersect(), false, 'it should return false.'
  ...
  test 'Test that "refine" works correctly for a TriangleMesh instance:', ->
    ...
    ok triangles[0].constructor.name is "Triangle", 'which contains a Triangle.'